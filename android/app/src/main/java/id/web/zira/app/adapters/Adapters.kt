...
class AccountAdapter(private val list: List<AccountModel>) : RecyclerView.Adapter<AccountAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.tvAccountBalance.text = item.balanceStr
...
class TransactionAdapter(private val list: List<TxnModel>, private val onItemClick: ((TxnModel) -> Unit)? = null) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (item.type == "income") {
            holder.binding.tvTxnAmount.text = "+ ${item.amountStr}"
